...
void TrackWidget::setActive(){
    QPalette slaveRowPalette;
    slaveRowPalette.setColor(QPalette::WindowText, QColor(255,255,0));
    this->setPalette(slaveRowPalette);
    //hlayout->setPalette(slaveRowPalette);
}
